      ...
      <table className="border border-gray-300" style={{ width: '85%' }}>
        ...
        <thead className="bg-blue-500 text-white">
          <tr>
            ...
            <th className="border border-gray-300 py-2 px-4">Batch Name</th>
            <th className="border border-gray-300 py-2 px-4">Technology</th>
        ...
        <tbody>
          {invoices && invoices.map((invoice) => (
            <tr key={invoice._id} className="border border-gray-300">
              ...
              <td className="border border-gray-300 py-2 px-4">{invoice.batchName}</td>
              <td className="border border-gray-300 py-2 px-4">{invoice.technology}</td>
