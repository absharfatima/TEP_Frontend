        ...
        <View style={styles.detailsContainer}>
          <View style={styles.details}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.value}>{invoiceData.batchName}</Text>
            </View>
            <View style={styles.section}>
              <Text style={styles.label}>Technology:</Text>
              <Text style={styles.value}>{invoiceData.technology}</Text>
            </View>
            <View style={styles.section}>
            ...
            <View style={styles.section}>
              ...
              <Text style={styles.value}>Rs. {invoiceData.amount} /-</Text>
            </View>
          </View>
        ...
        <div>
          {currentTrainings.map(training => (
            <div key={training._id} className="w-full md:w-[700px] border shadow-md ml-[12%] p-4 rounded-md mb-4 bg-gray-50">
              ...
              <div>Batch Name: {training.batchName}</div>
              <div>Technology: {training.technology}</div>
